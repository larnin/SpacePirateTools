#include "squarebrushmaptool.h"
#include <SFML/Graphics/RenderTarget.hpp>
#include <SFML/Graphics/Sprite.hpp>
#include <SFML/Graphics/RectangleShape.hpp>
#include <chrono>

SquareBrushMapTool::SquareBrushMapTool(TilemapData & data, const BrushSquare &brush)
    : BaseMapTool(data)
    , m_brush(brush)
{
...
void SquareBrushMapTool::onAddTile(const sf::Vector2u & pos)
{
    m_blocks.clear();
...
void SquareBrushMapTool::drawCursor(sf::RenderTarget &target, const sf::Vector2u & pos) const
{
