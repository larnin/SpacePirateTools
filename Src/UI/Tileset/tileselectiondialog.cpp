...
TileSelectionDialog::TileSelectionDialog(Texture texture, unsigned int delta, QWidget *parent)
    : QDialog(parent)
    , m_value(0)
{
    m_tileWidget = new TileSelectionWidget(texture, delta);
...
unsigned int TileSelectionDialog::getTileID(Texture texture, unsigned int delta, QWidget* parent, bool *ok)
{
    TileSelectionDialog dialog(texture, delta, parent);
